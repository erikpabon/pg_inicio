		...
		<section class="full-width header-well">
			...
			<div class="full-width header-well-text">
				<p class="text-condensedLight">
					Es muy importante que el cliente preste atención al proceso de adipiscado. Por lo cual acusamos no menos cuerpo de acusadores que la fuga de estos problemas nacidos de la necesidad.
				</p>
			</div>
		</section>
		<div class="mdl-tabs mdl-js-tabs mdl-js-ripple-effect">
			<div class="mdl-tabs__tab-bar">
				<a href="#tabNewPayment" class="mdl-tabs__tab is-active">Nueva</a>
